...
def ShowOutput():
    ...
    while True:
          ...
          if (numOfLines >= 120):
            break
    print('===============================================================================') # Show the Terminal output. This can be used to see if a device is already programed.
...
Showinfo = Button (root, text = 'Show COM Output', width= 20, command=ShowOutput).grid(row= 0, column= 1)
